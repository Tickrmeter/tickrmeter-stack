...
//Allowed currency signs are dollar, pound and euro only .. using in fxon only right now
export const allowedCurrencySigns = ["USD", "GBP", "EUR", "CAD", "HKD", "AUD", "NZD", "SGD"];
...
export const consoleLog = (x, mac) => debugDevices.includes(mac) && console.log(x);
