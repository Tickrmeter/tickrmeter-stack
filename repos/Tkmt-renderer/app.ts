...
if (require.main === module) {
  ...
  let mappingJson: { [key: string]: string | Graph }
   = { "Time": "14:23", "Number": "356 322 234", "Artist": "MrBeast","Title":"Blablablab blaw de", "Raise": "2.1%", "isUp": "false"};
  render(mappingJson, 'screen1.svg', 1);

  mappingJson = { "Time": "14:23", "Number": "356 322 234", "Artist": "MrBeast","Title":"Blablablab blaw de", "Raise": "2.1%", "isUp": "false"};
  render(mappingJson, 'screen2.svg', 2);

  mappingJson = { "Time": "14:23", "Number": "356 322 234", "Artist": "MrBeast","Title":"Blablablab blaw de", "Raise": "2.1%", "isUp": "false"};
 render(mappingJson, 'screen3.svg', 3);
