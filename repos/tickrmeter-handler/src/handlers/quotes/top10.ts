...
// import { getFormattedNumber, currencyList, ignoredCurrencySymbols } from "./helper";
// import { IGetQuoteFromAPI, IGetQuote } from "./interfaces";
...
//   const { symbolType, market, symbol, gainTracking, currency, multiplier } = params;

//   return symbolType === SYMBOL_TYPE.TOP10
//     ? await getTop10QuoteFromDB({ market, symbol, gainTracking, currency, multiplier })
