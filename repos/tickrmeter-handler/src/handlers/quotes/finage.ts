...
//! -----------------------------------------------------------------------------------------//
//! We are no longer using the finage API for quotes, this file is kept for reference.
//! -----------------------------------------------------------------------------------------//
...
// // Allowed markets for trading vie
...
//     if (isTradingViewEnabled && allowedMarketsForTradingView.includes(market)) return getDataFromTradingView(params);
...
//       const response: any = await http.getAPI(url, APISOURCES.FINAGE, true, true, 21600);
...
//   } catch (error) {
//     //console.error("Finage: Error in getStockPreviousClosing: ", error);
//     return _previousClosingPrice;
//   } finally {
//     http.dispose();
//   }
...
//     }
//   } catch (error) {
//     //console.error("Finage: Error in getForexPreviousClosing: ", error);
//     return 0;
//   } finally {
//     http.dispose();
//   }
...
//     return { success: true, data: response };
//   } catch (error) {
//     //  console.error("Finage: Error in getIndiceOrETFFromAPI: ", params?.symbol, error);
//     return { success: false, data: null };
//   } finally {
//     http.dispose();
//   }
...
//     }
//   } catch (error) {
//     //console.error("Finage: Error in getIndiceOrETFPreviousClosing: ", error);
//     return 0;
//   } finally {
//     http.dispose();
//   }
...
//   //market will be dk or se

//   //get data from redis
//   const key = `TV:${marketExchangeMap[market]}:${symbol.replace(/[. -]/g, "_")}`;
//   const data = await redis.get(key);
